 ...
 *                  then, presents user with a menu to interact with data.
 *
 *        Version:  1.0
...
#include <sstream> // for read strings with spaces
#include "Movie.h"
using namespace std;
...
void delete_movie(vector<Movie>& movies) 
{
    ...
    movies.erase(movies.begin() + index); // deleting record form vector
